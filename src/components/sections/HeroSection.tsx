  ...
  return (
    <section className="relative min-h-[92vh] flex flex-col items-center justify-center overflow-hidden pt-24 pb-12">
      ...
      <AnimatedGroup preset="blur-slide" className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        <img
          alt="DigiMoria"
          className="w-40 h-40 md:w-32 md:h-32 mx-auto mb-6 drop-shadow-md object-fill"
          src="/lovable-uploads/ad6e8aa7-b506-4fb2-b04f-a6758e104990.webp"
        />

        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold font-display leading-[1.08] mb-5 tracking-tight">
