    ...
    <section className="relative py-12 md:py-16">
      <div ref={ref} className={`reveal ${revealed ? "revealed" : ""} relative z-10 text-center`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          ...
          >
            <div className="absolute top-0 right-0 w-24 h-24 bg-muted/30 rounded-full -translate-y-1/2 translate-x-1/2" />
            ...
            <div className="flex gap-2 mt-4 pt-3 border-t border-border">
              ...
              <div className="flex items-center text-xs text-muted-foreground ml-2">Low quality leads</div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="flex gap-1.5 mt-4 pt-3 border-t border-primary/10 overflow-hidden">
              {revealed && Array.from({ length: 8 }).map((_, i) => (
                ...
                >
                  <div className="w-3.5 h-3.5 rounded-full bg-primary/25" />
                </motion.div>
              ))}
              <div className="flex items-center text-xs text-primary font-medium ml-2">+82</div>
            </div>
          </motion.div>
        </div>
      </div>
