  ...
  return (
    <section className="relative py-12 md:py-20">
      ...
      <div ref={ref} className={`reveal ${revealed ? "revealed" : ""} relative z-10 max-w-4xl mx-auto px-4 text-center`}>
        ...
        <h2 className="text-3xl md:text-5xl font-bold font-display mt-2.5 mb-3 text-foreground">
          Your Sales Team Only Focuses<br className="hidden md:block" /> on Real Meetings
        </h2>
        <p className="text-base text-muted-foreground max-w-xl mx-auto mb-10">
          Customer acquisition automations <b>custom-built for your company by our team</b> identify potential prospects, initiate contact, and convert them into meetings. As a result, your sales team can conduct meetings with <b>at least 30x more warm potential prospects</b>.
        </p>
