...
const SalesCalendarSection = () => {
  ...
  return (
    <section className="relative py-20 md:py-32">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_hsla(270,80%,55%,0.04)_0%,_transparent_50%)]" />
      ...
      <div ref={ref} className={`reveal ${revealed ? "revealed" : ""} relative z-10 max-w-4xl mx-auto px-4 text-center`}>
        ...
        <h2 className="text-3xl md:text-6xl font-bold font-display mt-3 mb-4 text-foreground">
        ...
        {/* Calendar */}
        <div className="glass-strong rounded-2xl p-4 md:p-6 max-w-lg mx-auto mb-12 text-left">
          ...
          <div className="space-y-2">
            {revealed && meetings.map((m, i) => (
              ...
              >
                <span className="text-xs font-mono text-primary w-12">{m.time}</span>
        ...
        >
          <Link
            to="/contact"
            className="inline-flex items-center gap-2 px-10 py-4 rounded-xl font-semibold font-display text-primary-foreground bg-primary hover:bg-primary/90 transition-all shadow-lg shadow-primary/20 text-lg"
          >
